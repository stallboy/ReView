...
namespace SharpGL
{
    ...
    public partial class OpenGLControl : UserControl, ISupportInitialize
    {
        ...
        {
			if (RenderContextType == RenderContextType.NativeWindow || RenderContextType == RenderContextType.NativeFBO)
                return;
        ...
        protected void Render(Graphics graphics)
        {
            ...
            if (DrawFPS)
            {
                OpenGL.DrawText(5, 5, 1.0f, 0.0f, 0.0f, "Courier New", 16.0f,
		...
		public bool FSAA
		{
			...
			set
			{
				if (fsaa != value)
				{
					...
					NativeFBORenderContextProvider rcp = OpenGL.RenderContextProvider as NativeFBORenderContextProvider;
					if (rcp != null)
					{
						rcp.MultiSamples = fsaa ? 8 : 1;
					}
				}
			}
		}
