...
namespace SharpGL
{
    public partial class OpenGL
    {
		...
		public bool ChoosePixelFormatARB(IntPtr handle, int[] intAttributes, float[] floatAttributes, int maxFormats, int[] formats, uint[] numFormats)
		{
			return (bool)InvokeExtensionFunction<wglChoosePixelFormatARB>(handle, intAttributes, floatAttributes, maxFormats, formats, numFormats);
		}

		private delegate bool wglChoosePixelFormatARB(IntPtr handle, int[] intAttributes, float[] floatAttributes, int maxFormats, int[] formats, uint[] numFormats);
		...
		{
			InvokeExtensionFunction<glBlitFramebufferEXT>(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
		}
